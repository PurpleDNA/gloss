...
| Small promotional tile | 440×280 PNG — optional | Not made |
| Large promotional tile | 1400×560 PNG — optional | Not made |
| YouTube video URL | optional | None |

Logos are generated by `npm run icons`; screenshots are normalised to the exact
size by `npm run screenshots`.
